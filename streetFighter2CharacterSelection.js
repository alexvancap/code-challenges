...
function streetFighterSelection(fighters, position, moves){
    let columnPos = position[0]
    let rowPos = position[1]
    let hoveredFighters = []
    ...
    moves.forEach(move => {
        ...
        case 'left':
            ...
            columnPos = fighters[rowPos].length -1
            break ;
        case 'right':
            if(columnPos != fighters[rowPos].length -1)
            columnPos += 1
            else
            columnPos = 0
            break ;
        ...
        hoveredFighters.push(fighters[rowPos][columnPos])
    })
